      ...
      <div className="hero-element flex flex-wrap items-center gap-3 text-sm font-medium text-neutral-600 mt-2">
        ...
        {contact.phone ? (
          ...
          >
            ...
            <span className="print:inline print:text-black print:underline print:underline-offset-2">{contact.phone}</span>
          </a>
        ) : null}
        ...
        {contact.email ? (
          <a
            ...
            aria-label="Email"
            className="print-link inline-flex h-10 w-10 items-center justify-center rounded-full border border-neutral-200 bg-white transition hover:bg-neutral-100 print:inline print:h-auto print:w-auto print:rounded-none print:border-0 print:bg-transparent print:px-0 print:py-0"
          >
            ...
            <span className="hidden print:inline break-all print:text-black print:underline print:underline-offset-2">{contact.email}</span>
          </a>
        ) : null}
        ...
        {contact.whatsapp ? (
          <a
            ...
            rel="noreferrer"
            aria-label="WhatsApp"
            className="print-link inline-flex h-10 w-10 items-center justify-center rounded-full border border-neutral-200 bg-white transition hover:bg-neutral-100 print:inline-block print:h-auto print:w-auto print:rounded-none print:border-0 print:bg-transparent print:px-0 print:py-0"
          >
            <span className="print:hidden">
            ...
            <span className="hidden print:inline print:text-black print:underline print:underline-offset-2 print:break-all">
        ...
        {contact.googleScholar ? (
          ...
          >
            ...
            <span className="hidden print:inline print:text-black print:underline print:underline-offset-2 print:break-all">
              Google Scholar: {contact.googleScholar}
            </span>
          </a>
        ) : null}
      </div>
