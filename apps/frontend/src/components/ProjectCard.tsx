...
export default function ProjectCard({ title, description, techStack, githubUrl, liveUrl, imageUrl }: ProjectCardProps) {
  return (
    <TiltCard className="rounded-2xl border border-neutral-200/80 bg-white dark:bg-neutral-900/70 dark:border-neutral-800 shadow-xs hover:shadow-xl transition-all duration-300">
      <div className="group flex flex-col h-full overflow-hidden rounded-2xl">
